...
(function () {
  const mapdemo = document.createElement("template");
  mapdemo.innerHTML = `
      <style>
      </style>
  ...
  class SamplePrepared extends HTMLElement {
    constructor() {
      ...
      this._shadowRoot.appendChild(mapdemo.content.cloneNode(true));
  ...
  customElements.define("com-sap-sample-echarts-mapdemo", SamplePrepared);
})();
